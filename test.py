...
|_   \  /   _|.' ____ \ |_   __  | • MULTISIMPLEFORCE •
{K}  |   \/   |  | (___ \_|  | |_ \_|   • TIDAK DIJUAL •
  | |\  /| |   _.____`.   |  _|    
{B} _| |_\/_| |_ | \____) | _| |_     
...
def _____bot________():
	try:
		...
		______LuWibu______(" %s[!] expired tokens!"%(M))
...
def _____Publik_______():
	...
	try:
		...
		______DICKYXD______(P+' ['+h+'!'+P+'] TARGET FRIENDSHIP NOT PUBLISHED')
		______LuWibu______()
	______DICKYXD______(f" \n {P}[{H}?{P}] Do you want to use manual password? [y/n] ")
